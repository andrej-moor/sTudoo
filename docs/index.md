...
With sTudoo we try to code a web app which should help to reduce the stress in our student lives, indlucing lecture descriptions, semester calendar and custom to-do lists.
